...
private:
  ...
  virtual bool PublishInternal(const char* topic, const char* payload, bool retain);

public:
  MqttMessageBus(const char* serverHost, int serverPort, JsonSerializationProvider* serializationPrivider, MessageHandler* handler, const char* deviceId);
